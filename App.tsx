          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              <a href="https://medicalresearch.nsw.gov.au/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 hover:opacity-90 transition-opacity">
                ...
                <div className="flex flex-col border-l-2 border-nsw-grey-200 pl-4 py-1 justify-center">
                  <span className="text-lg md:text-xl font-bold text-[#002664] tracking-tight leading-none">
